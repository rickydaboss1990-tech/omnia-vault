...
### 34. Unquoted System Values and Status Tags (local addition)

**Problem:** Prose that drops a literal system value into a sentence without quotes (a
status tag, a placeholder record name, a field value like "not found") reads like
machine output spliced into text. A person writing about a system quotes the literal so
the reader can tell the value apart from the sentence around it.
**Rule:** Wrap literal status values, tags, and placeholder names in straight quotes
when they appear inline in prose: "Institution Not Found", "not found", "Begin
Submission Validation". Do not quote ordinary nouns, table or field names used
descriptively, numbers, or code already inside backticks.
**Before:**
> When Related Institution comes out Institution Not Found, the AI updates Other Institution. The resources got Institution Not Found because those banks do not exist.
**After:**
> When Related Institution comes out "Institution Not Found", the AI updates Other Institution. The resources got "Institution Not Found" because those banks do not exist.
